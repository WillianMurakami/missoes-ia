(function applyFinalMissionOverrides() {
  ...
  const references = [
    ...
    { level: "Iniciante", order: 3, title: "Treinamento Copilot UOL", producer: "Uni UOL", tag: "Curso interno", url: "https://uni.uol.com.br/missions/Qf8wPJQ3ZSfmb8Td1vc4" },
  ...
  function referenceSummary(item) {
    if (item.url === "https://uni.uol.com.br/missions/Qf8wPJQ3ZSfmb8Td1vc4") return "Treinamento ministrado por Especialista Microsoft";
